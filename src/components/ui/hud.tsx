...
function InfoIcon(props: InfoIconProps) {
  return (
    <div
      class="flex h-full w-6 flex-col items-center justify-between text-lg"
      title={props.title}
    >
      {props.svg}
      {props.value}
...
export default function HUD() {
  ...
  return (
    <div class="absolute flex w-screen justify-between p-4 max-sm:bottom-0 sm:top-0">
      ...
      <div class="flex items-center gap-3">
        <InfoIcon
          ...
          value={gameContext?.store.health}
          svg={
            <svg
              class="fill-red-600"
        ...
        />
        <InfoIcon
          title="Rooms remaining"
          value={gameContext?.roomsRemaining()}
          svg={
            <svg
